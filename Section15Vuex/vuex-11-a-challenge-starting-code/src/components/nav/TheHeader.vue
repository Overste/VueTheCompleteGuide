...
const { cartQty } = storeToRefs(store);

const main = mainStore();
const { getIsLoggedIn } = storeToRefs(main);

// Make the products available to the template
// const products = getProducts;
const cartQuantity = computed(() => cartQty.value);
const isLoggedIn = computed(() => getIsLoggedIn.value);
